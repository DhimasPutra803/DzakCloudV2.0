          ...
          <div className="p-6 space-y-6">
            ...
            >
              <div className="flex justify-between items-center mb-2">
                <p className={cn(isDark ? "text-slate-300" : "text-slate-600")}>
                  Paket:
                </p>
                <p
                  className={cn(
            ...
            {paymentMethod === "qris" && (
              <div
                className={cn(
                  "p-4 border rounded-lg space-y-4 text-center",
                  isDark
              ...
              >
                ...
                <img
                  src="/qris.png"
                  alt="QRIS"
                  className="w-44 h-44 mx-auto rounded-lg border"
                />

                <p className="text-sm opacity-70">
                  Scan menggunakan Dana, OVO, GoPay, ShopeePay, atau Mobile
                  Banking
                </p>
            ...
            <div className="space-y-3">
              ...
              {[{ id: "qris", label: "QRIS", icon: "🔳" }].map((method) => (
                <label
                  key={method.id}
                  className={cn(
