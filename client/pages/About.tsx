        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-start mb-12 md:mb-20">
            ...
            <div>
              ...
              {/* Visi Section */}
              <div className="mb-8 md:mb-12">
                <h2 className="text-lg md:text-xl font-semibold text-blue-400 mb-3 md:mb-4">Visi</h2>
                <p className={cn("leading-relaxed text-slate-300 text-sm md:text-base")}>
                  DzakCloud adalah visi perusahaan yang ingin di bidang layanan teknologi informasi. Membangun perusahaan di industri teknologi informasi. Adalah pengguna untuk memberikan solusi teknologi terdepan yang memenuhi kebutuhan digital masa kini.
                </p>
              </div>

              {/* Misi Section */}
              <div className="mb-8 md:mb-12">
                <h2 className="text-lg md:text-xl font-semibold text-blue-400 mb-3 md:mb-4">Misi</h2>
                <p className={cn("leading-relaxed text-slate-300 text-sm md:text-base")}>
                  Memberikan inovasi, peluang, startup, dan UMKM dalam memberikan teknologi cloud secara efisien, aman, dan terjangkau. Kami percaya bahwa teknologi harus accessible untuk semua kelangsungan.
                </p>
              </div>

              {/* Didirikan Tahun Section */}
              <div>
                <h2 className="text-lg md:text-xl font-semibold text-blue-400 mb-3 md:mb-4">Didirikan Tahun 2026</h2>
                <p className={cn("leading-relaxed text-slate-300 text-sm md:text-base")}>
                  Perusahaan DzakCloud didirikan sebagai harapan, komitmen, dan koneksitas dalam membangun sebuah teknologi terdepan yang memanfaatkan infrastruktur digital masa kini dan profesionalisme tim kami.
                </p>
              </div>
            </div>
              ...
              <div className="flex flex-col items-center gap-6 md:gap-8">
                ...
                <div className="relative w-48 h-48 sm:w-56 sm:h-56 md:w-64 md:h-64 lg:w-72 lg:h-72">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className={cn(
                      "rounded-full w-40 h-40 sm:w-48 sm:h-48 md:w-56 md:h-56 lg:w-56 lg:h-56 flex items-center justify-center transition-all duration-300",
                      isDark
                        ? "bg-blue-600/20 border border-blue-500/30 hover:border-blue-400/50"
                        : "bg-blue-300/20 border border-blue-400/30 hover:border-blue-500/50"
                    )}>
                      <img
              ...
              <div className={cn(
                ...
                <ul className="space-y-2 md:space-y-3">
                  <li className="flex items-start gap-2 md:gap-3">
                    <span className="text-blue-400 font-bold mt-1 text-sm md:text-base">•</span>
                    <div>
