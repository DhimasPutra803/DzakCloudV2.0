    ...
    <div class="pt-32 pb-20 px-6 flex items-center justify-center relative z-10 min-h-screen">
        <div class="w-full max-w-md">
            ...
            <div class="bg-slate-800/50 dark:bg-slate-900/50 border border-slate-700 dark:border-slate-800 rounded-2xl p-8 backdrop-blur-sm">
                ...
                <!-- Demo Credentials -->
                <div class="bg-slate-700/30 dark:bg-slate-800/30 border border-slate-600 dark:border-slate-700 rounded-lg p-4 mb-6">
                    <p class="text-slate-300 dark:text-slate-400 text-sm mb-3 font-medium">
                        📝 Demo Akun:
                    </p>
                    <p class="text-slate-400 dark:text-slate-500 text-xs mb-1">
                        Email: <span class="text-white dark:text-slate-300 font-mono">demo@example.com</span>
                    </p>
                    <p class="text-slate-400 dark:text-slate-500 text-xs">
                        Password: <span class="text-white dark:text-slate-300 font-mono">password</span>
                    </p>
                </div>
